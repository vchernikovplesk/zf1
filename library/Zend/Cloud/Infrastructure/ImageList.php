...
class Zend_Cloud_Infrastructure_ImageList implements Countable, Iterator, ArrayAccess
{
     ...
     *
     * @return Zend_Cloud_Infrastructure_Image|null
     */
    public function current(): ?Zend_Cloud_Infrastructure_Image
    {
     ...
     */
    public function offsetGet($offset): Zend_Cloud_Infrastructure_Image
    {
